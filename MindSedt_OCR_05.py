...
#['сийскл ® Рлция', 'ОТДЕЛОМ ВНУТРЕННИХ ДЕЛ', 'ГОР. КРАСНОЗНАМЕНСК', '', '16.10.2016 ›__. 100-128', '', 'НИКОЛАЕВНА', 'Ве 14.09.1985', 'ГОР. КРАСНОЗНАМЕНСК', '', 'з', '>', '©', '=', 'Е', '2', '2', '=', 'я', '', '<<<Пробная страничка Паспорт РФ 2017>>>', '<<<Стоимость программы 10 $>>>', '', '<<<Ета11: Васкег1аБпем@дтаз1.сот>>>>', '', '']
