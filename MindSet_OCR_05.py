...
#['иискл', '', 'ОТДЕЛОМ УФМС РОССИИ ПО', 'САМАРСКОЙ ОБЛАСТИ В ЦЕНТРАЛЬНОМ', 'РАЙОНЕ ГОРОДА ТОЛЬЯТТИ', 'мт вы 08 . 05.2006. „злрельвта 112-009', '', '©', '==', '>', '[=]', '>', '=', '©', 'со', '©', '—', '', 'ДАЙМОНД', '', 'ДМИТРИЙ', 'АЛЕКСЕЕВИЧ', '. 2 06.05.1986', 'ГОР. САМАРА', '', 'Е,', 'Ч', 'а', '', 'ИАЦ', '', '10', '`', '', '188010 90 16', '', '']
